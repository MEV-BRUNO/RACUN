...
DROP TABLE IF EXISTS `racunstavka`;
...
CREATE TABLE `racunstavka` (
  ...
  `rabat` smallint(10) DEFAULT NULL,
...
LOCK TABLES `racunstavka` WRITE;
/*!40000 ALTER TABLE `racunstavka` DISABLE KEYS */;
/*!40000 ALTER TABLE `racunstavka` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-04-27 17:43:29
